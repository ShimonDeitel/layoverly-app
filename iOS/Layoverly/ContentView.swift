            ...
            ZStack {
                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 16) {
                        TextField("Airport", text: $primaryText)
                            .textFieldStyle(.roundedBorder)
                            .accessibilityIdentifier("field_primary")
                        TextField("Plan / Notes", text: $secondaryText, axis: .vertical)
                            .textFieldStyle(.roundedBorder)
                            .accessibilityIdentifier("field_secondary")
                        
                    TextField("Duration (hrs)", text: $numericText)
                        .keyboardType(.decimalPad)
                        .textFieldStyle(.roundedBorder)
                        .accessibilityIdentifier("field_numeric")
                        
                    TextField("Terminal", text: $tag)
                        .textFieldStyle(.roundedBorder)
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") {
                        let entry = LogEntry(
                            ...
                            numericValue: Double(numericText)
                        )
                        store.add(entry)
                        dismiss()
                    }
